...
export default function LandingPage() {
    return (
        <>
            <Navbar />
            <div className="relative h-screen w-full bg-black overflow-hidden" style={{cursor: "url('../public/cursor.cur'), auto"}}>
                <div className="w-screen h-[80vh] absolute flex items-center justify-center mt-20 px-10 gap-5 z-20">
                    <div className="flex flex-col justify-center items-start ml-10 max-w-xl">
                        ...
                        <button className="px-6 py-3 bg-[#027FAE] text-white font-semibold rounded-full hover:bg-[#0393C9] transition duration-300 cursor-pointer"> Connect Now </button>
                    </div>
